      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div key={i} className="border rounded p-3 space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <input
                    value={d.name}
                    onChange={(e) =>
                      updateListItem("dishes", i, "name", e.target.value)
                    }
                    placeholder="菜名"
                  ...
                  <input
                    value={d.main_cut}
                    onChange={(e) =>
                      updateListItem("dishes", i, "main_cut", e.target.value)
                    }
                    placeholder="主要刀工"
                    className="border rounded px-2 py-1 text-sm"
                  />
                  <input
                    value={d.method}
                    onChange={(e) =>
                      updateListItem("dishes", i, "method", e.target.value)
                    }
                    placeholder="烹調法"
                    className="border rounded px-2 py-1 text-sm"
                  />
                ...
                <input
                  value={d.seasoning}
                  onChange={(e) =>
                    updateListItem("dishes", i, "seasoning", e.target.value)
                  }
                  placeholder="調味規定"
                  className="w-full border rounded px-2 py-1 text-sm"
                />
                <input
                  value={d.notes}
                  onChange={(e) =>
                    updateListItem("dishes", i, "notes", e.target.value)
                  }
            ...
            {form.material_items.map((m, i) => (
              ...
              >
                <input
                  value={m.name}
                  onChange={(e) =>
                    updateListItem("material_items", i, "name", e.target.value)
                  }
                  placeholder="品名"
                  className="border rounded px-2 py-1 text-sm"
                />
                <input
                  value={m.spec}
                  onChange={(e) =>
                    updateListItem("material_items", i, "spec", e.target.value)
                  }
                  placeholder="規格"
                  className="border rounded px-2 py-1 text-sm"
                />
                <input
                  value={m.qty}
                  onChange={(e) =>
                    updateListItem("material_items", i, "qty", e.target.value)
                  }
                  placeholder="重量/數量"
                  className="border rounded px-2 py-1 text-sm"
                />
                <input
                  value={m.note}
                  onChange={(e) =>
                    updateListItem("material_items", i, "note", e.target.value)
                  }
                  placeholder="備註"
                  className="border rounded px-2 py-1 text-sm"
                />
            ...
            {form.knife_work_items.map((k, i) => (
              ...
              >
                ...
                <input
                  value={k.qty}
                  onChange={(e) =>
                    updateListItem("knife_work_items", i, "qty", e.target.value)
                  }
                  placeholder="數量規定"
                  className="border rounded px-2 py-1 text-sm"
                />
        ...
        <section>
          ...
          <textarea
            ...
            onChange={(e) =>
              updateField("plating_options", linesToArray(e.target.value))
            }
            rows={3}
            className="w-full border rounded px-2 py-1 text-sm"
          />
